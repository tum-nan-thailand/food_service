  ...
  <div class="modal fade" id="frm_list_detail" role="dialog">
          ...
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title">@if(isset($datas))
                    {{'แก้ไขกลุ่มอาหาร'}}
                    @else{{'สร้างรายการอาหาร'}} @endif</h4>
            </div>
            <div class="modal-body">
                    ...
                    <div class="col-xs-6">
                            ...
                            <div class="col-xs-6">
                                    ...
                                    <textarea placeholder="อัตโนมัติ" name="detail"  readonly="true" class="form-control" rows="3" id="detail_material">
    ...
    $('#id_material_group').change(function (e) {
     ...
     $('#run_no').change(function (e) {
         ...
         $.ajax({
                                type: "get",
                                url: "{{url('food/CheckDuplicate_form_detail_tmp')}}",
                                data: {
                                    _token : '{{csrf_token()}}',
                                    id:$(this).val(),
                                },
            ...
            function validate() {
                ...
                $('form#frm').find('input,select,textarea').each(
                    ...
                    if($(this).prop('required')){
                                ...
                                //      if (input.attr('name') === "run_no_defult" && input.val() != undefined) {
                                //              if (input.val() != undefined && input.val() != '') {
                                //                 html_ +='<td>';
                                //                 html_ +=''+num +''
                                //                 html_ += '<input type="hidden" value="'+ num +'" name="run_no[]">';
                                //                 html_ +='</td>';
                                //               }
                                //      }

                                //     if (input.attr('name') === "id_material_group" && input.val() != undefined) {
                                //             if (input.val() != undefined && input.val() != '') {
                                //                 html_ +='<td>';
                                //                 html_ +=''+ input.val() +''
                                //                 html_ += '<input type="hidden" value="'+ input.val() +'" name="id_material_group[]">';
                                //                 html_ +='</td>';
                                //             }
                                //     }

                                //     if (input.attr('name') === "group_name_material" && input.val() != undefined) {
                                //             if (input.val() != undefined && input.val() != '') {
                                //                 html_ +='<td>';
                                //                 html_ +=''+ input.val() +''
                                //                 html_ += '<input type="hidden" value="'+ input.val() +'" name="group_name_material[]">';
                                //                 html_ +='</td>';
                                //             }
                                //     }

                                //     if (input.attr('name') === "unit" && input.val() != undefined) {
                                //             if (input.val() != undefined && input.val() != '') {
                                //                 html_ +='<td>';
                                //                 html_ +=''+ input.val() +''
                                //                 html_ += '<input type="hidden" value="'+ input.val() +'" name="unit[]">';
                                //                 html_ +='</td>';
                                //             }
                                //     }

                                //     if (input.attr('name') === "qty" && input.val() != undefined) {
                                //             if (input.val() != undefined && input.val() != '') {
                                //                 html_ +='<td>';
                                //                 html_ +=''+ input.val() +''
                                //                 html_ += '<input type="hidden" value="'+ input.val() +'" name="qty[]">';
                                //                 html_ +='</td>';
                                //             }
                                //     }

                                //     if (input.attr('name') === "price" && input.val() != undefined) {
                                //             if (input.val() != undefined && input.val() != '') {
                                //                 html_ +='<td>';
                                //                 html_ +=''+ input.val() +''
                                //                 html_ += '<input type="hidden" value="'+ input.val() +'" name="price[]">';
                                //                 html_ +='</td>';


                                //     html_ +='<td>';
                                //         html_ +='<a name="" id="" onclick="del_d(\'row_d'+num+'\')" class="btn btn-danger btn-sm" href="#" role="button"><i class="fa fa-minus" aria-hidden="true"></i></a>';
                                //     html_ +='</td>';
                                //             }
                                //     }
                ...
                <?php }else{ ?>
                        add_form_tmp();
                 <?php   }    ?>
                    //    $('#form-table > tbody:last-child').append(html_);
            ...
            const add_form_tmp = () =>{
                ...
                $('#report').html(load);
                          $.ajax({
                                type: "post",
                                url: "{{url('food/add_form_detail_tmp')}}",
                                data: $("#frm").serialize(),
                                datatype: 'json'
                              })
                            .done(function (res) {
            ...
            const update_form_tmp = () =>{
                ...
                $('#report').html(load);
                          $.ajax({
                                type: "post",
                                url: "{{url('food/update_form_tmp_form_detail_tmp')}}",
                                data: $("#frm").serialize(),
                                datatype: 'json'
                              })
                            .done(function (res) {
